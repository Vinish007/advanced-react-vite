    ...
    <div className={`container ${isSignUpMode ? 'sign-up-mode' : ''}`}>
      ...
      <div className="panel left-panel">
          <div className="content">
             <h3>Party Management Hub: Where Every Detail Matters</h3>
             <p>"Unlock Seamless Experiences, Sign in to start Journey. Where Every Detail Finds its Place, Every Moment Echoes Perfection. Let's Make Your Party Unforgettable Together."
         ...
         <div className="panel right-panel">
           <div className="content">
            <h3>Join the Celebration: Sign Up for Seamless Party Management</h3>
             <p>Embark on a Journey with us. Sign up and Let's Create Moments that Last a Lifetime. Your Vision, Our Expertise - Together, Unleash Unforgettable Experiences.
